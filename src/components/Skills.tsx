...
const skillCategories: SkillCategory[] = [
  {
    ...
    skills: [
      ...
      },
      {
        name: "React",
        level: 92,
        description: "Hooks, Context API, React Router, Redux",
      },
      {
        name: "Tailwind CSS",
        level: 90,
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "NestJs", level: 80, description: "Apollo Server, TypeScript" },
      {
        name: "MongoDB",
        level: 70,
        description: "NoSQL Database, Mongoose, Aggregation Pipeline",
      },
      {
        name: "GraphQL",
        level: 65,
    ...
    skills: [
      {
        name: "Git & GitHub",
        level: 95,
        description: "Version control, branching strategies, GitHub Flow",
      },
      {
        name: "Testing",
        level: 90,
      ...
      },
      {
        name: "Accessibility",
        level: 90,
        description: "WCAG guidelines, screen readers, keyboard navigation",
      },
      {
        name: "Performance",
        level: 85,
      ...
      },
      {
        name: "SEO",
        level: 80,
        description: "Metadata, structured data, sitemap generation",
      },
    ],
  },
];
